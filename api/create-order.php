...
// Get user ID if not provided but email is
if ($user_id == 0 && !empty($customer_email)) {
...
try {
    ...
    // ============================================
    // UPDATE USER SPENDING AND TIER - AUTOMATIC
    // ============================================
    updateUserSpendingAndTier($pdo, $customer_email, $total);
...
// ============================================
// FUNCTION TO UPDATE USER SPENDING AND TIER
// ============================================
function updateUserSpendingAndTier($pdo, $email, $orderTotal) {
    try {
        // Add order total to user's total_spent
        ...
        error_log("User $email: Total spent updated, tier recalculated");
        return true;
